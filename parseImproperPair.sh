...
echo "python bamPerseSV2.py ${INPUTBAM} ${REGION} > ${OUTPUTDIR}/tmp/${REGION}.improperPair.temp.txt"
python bamPerseSV2.py ${INPUTBAM} ${REGION} > ${OUTPUTDIR}/tmp/${REGION}.improperPair.temp.txt
