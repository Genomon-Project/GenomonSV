...
echo "python filterLengthNum.py ${TUMORDIR}/merge.junction.summarized.bedpe.gz 3 10 > ${TUMORDIR}/merge.junction.summarized.filt1.bedpe"
python filterLengthNum.py ${TUMORDIR}/merge.junction.summarized.bedpe.gz 3 10 > ${TUMORDIR}/merge.junction.summarized.filt1.bedpe
check_error $?
...
echo "python filterMergedJunc.py ${TUMORDIR}/merge.junction.summarized.filt3.bedpe 3 40 75 > ${TUMORDIR}/merge.junction.summarized.filt4.bedpe"
python filterMergedJunc.py ${TUMORDIR}/merge.junction.summarized.filt3.bedpe 3 40 75 > ${TUMORDIR}/merge.junction.summarized.filt4.bedpe 
check_error $?
