...
echo "python filterMergedJunc.py ${TUMORDIR}/merge.junction.summarized.filt3.bedpe 3 40 120 > ${TUMORDIR}/merge.junction.summarized.filt4.bedpe"
python filterMergedJunc.py ${TUMORDIR}/merge.junction.summarized.filt3.bedpe 3 40 120 > ${TUMORDIR}/merge.junction.summarized.filt4.bedpe 
check_error $?
