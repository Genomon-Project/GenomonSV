...
class TestFilt(unittest.TestCase):
    ...
    def test3(self):
        ...
        output_file = tmp_dir + "/5929_tumor.genomonSV.result.txt"
        answer_file = cur_dir + "/data/parse/5929_tumor.genomonSV.result.edlib.txt"

        print(' '.join(["filt", tumor_bam, output_prefix, ref_genome, "--grc", "--matched_control_bam", control_bam, "--edlib"]))
        args = self.parser.parse_args(["filt", tumor_bam, output_prefix, ref_genome, "--grc", "--matched_control_bam", control_bam, "--edlib"])
        args.func(args)
    ...
    def test4(self):
        ...
        output_file = tmp_dir + "/5929_tumor.genomonSV.result.txt"
        answer_file = cur_dir + "/data/parse/5929_tumor.genomonSV.result.parasail.txt"
